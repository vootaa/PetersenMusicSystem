...
class PrimaryCategory(Enum):
    """主要类别"""
    TRADITIONAL_EXTENSION = "traditional_extension"      # 传统扩展型
    MICROTONAL_EXPLORATION = "microtonal_exploration"    # 微分音探索型
    EXPERIMENTAL_AVANT_GARDE = "experimental_avant_garde" # 实验前卫型
    WORLD_MUSIC_FUSION = "world_music_fusion"           # 世界音乐融合型
    SOUND_ART_DESIGN = "sound_art_design"               # 声音艺术型
    THERAPEUTIC_FUNCTIONAL = "therapeutic_functional"    # 治疗功能型
    COMPREHENSIVE_HYBRID = "comprehensive_hybrid"        # 综合混合型
    RESEARCH_EXPLORATION = "research_exploration"        # 研究探索型
