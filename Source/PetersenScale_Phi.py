...
if __name__ == "__main__":
    ...
    python PetersenScale_Phi.py --compare_dth                     # 比# filepath: /Users/tsb/vootaa/vootaa@github/PetersenMusicSystem/Source/PetersenScale_Phi.py
"""
Petersen 可变比例音区模块（库形式）
...
if __name__ == "__main__":
    ...
    python PetersenScale_Phi.py --preset sqrt3 --dth_preset 72_div_2  # φ=√3, δθ=36°
    python PetersenScale_Phi.py --phi 1.25 --delta_theta 60       # 使用自定义值
    python PetersenScale_Phi.py --compare                         # 比较所有φ预